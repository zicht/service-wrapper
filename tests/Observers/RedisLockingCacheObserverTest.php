...
class RedisLockingCacheObserverTest extends TestCase
{
     ...
     */
    public function testCacheMissLock()
    {
     ...
     */
    public function testCacheMissBusyWait()
    {
        $this->redisLockingCacheObserver->expects($this->exactly(1))->method('createToken')->with()->willReturn('token-12345');
        $this->serviceWrapper->expects($this->never())->method('__call');
     ...
     * @param mixed $ttlResponse
     */
    public function testGraceCacheHitWithoutGraceRefresh($ttlResponse)
    {
        $this->redisLockingCacheObserver->expects($this->never())->method('createToken');
        $this->serviceWrapper->expects($this->never())->method('__call');
     ...
     * @return array
     */
    public function noGraceRefreshTtlProvider()
    {
        return [
            ['ttlResponse' => 20],
            ['ttlResponse' => 21],
     ...
     * @param mixed $ttlResponse
     */
    public function testGraceCacheHitWithGraceCheckWithoutRefresh($ttlResponse)
    {
        $this->redisLockingCacheObserver->expects($this->exactly(1))->method('createToken')->with()->willReturn('token-12345');
        $this->redis->expects($this->exactly(1))->method('get')->with('grace_cachable:[]')->willReturn(['g' => 20, 'e' => null, 'v' => 'data-response']);
        $this->redis->expects($this->exactly(1))->method('ttl')->with('grace_cachable:[]')->willReturn($ttlResponse);
     ...
     * @param mixed $ttlResponse
     */
    public function testGraceCacheHitWithGraceCheckWithRefresh($ttlResponse)
    {
        $this->redisLockingCacheObserver->expects($this->exactly(1))->method('createToken')->with()->willReturn('token-12345');
        $this->redis->expects($this->exactly(1))->method('get')->with('grace_cachable:[]')->willReturn(['g' => 20, 'e' => null, 'v' => 'data-response']);
     ...
     * @param mixed $ttlResponse
     */
    public function testGraceCacheHitWithGraceCheckWithLateIgnore($ttlResponse)
    {
        $this->redisLockingCacheObserver->expects($this->exactly(1))->method('createToken')->with()->willReturn('token-12345');
        $this->redis->expects($this->exactly(1))->method('get')->with('grace_cachable:[]')->willReturn(['g' => 20, 'e' => null, 'v' => 'data-response']);
     ...
     * @return array
     */
    public function graceRefreshTtlProvider()
    {
        return [
