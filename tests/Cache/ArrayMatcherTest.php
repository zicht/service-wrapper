...
class ArrayMatcherTest extends TestCase
{
    ...
    public function testIsMatchMatchesExactMethodName()
    {
        $this->assertTrue($this->matcher->isMatch(new Request('methodA')));
    }

    public function testIsMatchCaseSensitive()
    {
    ...
    public function testKeyIsDifferentIfParametersDiffer()
    {
    ...
    public function testKeyIsDifferentIfMethodNamesDiffer()
    {
        $this->assertNotEquals(
            $this->matcher->getKey(new Request('methodA', ['a' => 'b'])),
    ...
    public function testKeyIsMatchingIsCaseSensitive()
    {
        $this->assertNotEquals(
    ...
    public function testKeyIsNotInfluencedByUnconfiguredAttributes()
    {
        $this->assertEquals(
            $this->matcher->getKey(new Request('methodA', ['a' => 'b'])),
    ...
    public function testKeyIsDifferentWhenAttributesAreAvailable()
    {
        $this->assertNotEquals(
            $this->matcher->getKey(new Request('methodA', ['a' => 'b'])),
            $this->matcher->getKey(new Request('methodA', ['a' => 'b'], ['five' => 'foo']))
    ...
    public function testKeyIsDifferentWhenAttributeValuesAreDifferent()
    {
        $this->assertNotEquals(
            $this->matcher->getKey(new Request('methodA', ['a' => 'b'], ['five' => 'foo'])),
    ...
    public function testGetTtlReturnsSpecifiedFallbackTtlForMethodForAllParameters()
    {
    ...
    public function testGetTtlReturnsLowestAttribute()
    {
